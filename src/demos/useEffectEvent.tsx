...
// and every change of the step would reset the timer to a new round.`,
    ...
    leftChip: 'timer restarted',
    rightChip: 'timer kept alive',
    leftHint: 'the bar jumps back to 0 — every change of the step kills the interval and starts a new one.',
    rightHint: 'the bar never stutters — one interval for the whole lifetime, and the step is read fresh.',
...
// и каждый выбор шага сбрасывал бы таймер на новый круг.`,
    ...
    rightTitle: 'useEffectEvent',
    leftChip: 'таймер сброшен',
    rightChip: 'таймер живёт',
    leftHint: 'полоска прыгает в 0 — каждая смена шага убивает интервал и заводит новый.',
    rightHint: 'полоска не сбивается — интервал один на всё время жизни, а шаг читается свежий.',
